...
import { Search, Plus, ExternalLink, Filter, TrendingUp } from "lucide-react";
    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto w-full flex flex-col h-full overflow-hidden">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Live odds from top prediction markets.</p>
        </div>

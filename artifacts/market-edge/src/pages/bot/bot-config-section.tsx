import { Bot, Pause, Play, TrendingUp, TrendingDown, Clock, DollarSign, BarChart3, Target, Star, CheckCircle2, XCircle, RefreshCw, Shield, Zap, ArrowUp, ArrowDown, Trophy, Minus, Settings, ChevronDown, ChevronUp, Activity, Brain, ChevronLeft, ChevronRight, ShoppingCart, X, RotateCcw, Save } from "lucide-react";
          ...
          {configOpen && cfg && (
            <div className="min-w-0 p-3 sm:p-5 space-y-4 sm:space-y-5">
              ...
              <PerCoinOverrides
                ...
                onChange={coinOverrides => setConfigDraft(d => ({ ...d, coinOverrides }))}
              />

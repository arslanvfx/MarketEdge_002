// The scannable stock universe, grouped by GICS sector. These are liquid,
// large-cap S&P 500 names with reliable data and news coverage — ideal for
// an automated bot. The scanner ranks across this set; the user's watchlist
// is merged on top.
...
export const STOCK_UNIVERSE: UniverseEntry[] = [
  ...
  { ticker: "FICO",   name: "Fair Isaac (FICO)",          sector: "Technology" },
  ...
  { ticker: "BR",     name: "Broadridge Financial",       sector: "Technology" },
  { ticker: "PAYC",   name: "Paycom Software",            sector: "Technology" },
  { ticker: "GDDY",   name: "GoDaddy",                    sector: "Technology" },
  { ticker: "DT",     name: "Dynatrace",                  sector: "Technology" },
  ...
  { ticker: "PODD",   name: "Insulet Corporation",        sector: "Healthcare" },
  ...
  { ticker: "LH",     name: "Laboratory Corp",            sector: "Healthcare" },
  ...
  { ticker: "CRL",    name: "Charles River Laboratories", sector: "Healthcare" },
  ...
  { ticker: "MASI",   name: "Masimo",                     sector: "Healthcare" },
  ...
  { ticker: "COTY",   name: "Coty Inc.",                  sector: "Consumer Staples" },
  ...
  { ticker: "DLB",    name: "Dolby Laboratories",         sector: "Communication Services" },
  ...
  { ticker: "HEI",    name: "Heico Corporation",          sector: "Industrials" },
  ...
  { ticker: "TKR",    name: "Timken Company",             sector: "Industrials" },
  { ticker: "FLS",    name: "Flowserve",                  sector: "Industrials" },
  { ticker: "NDSN",   name: "Nordson",                    sector: "Industrials" },
  { ticker: "SRCL",   name: "Stericycle",                 sector: "Industrials" },
  ...
  { ticker: "BLL",    name: "Ball Corporation",           sector: "Materials" },

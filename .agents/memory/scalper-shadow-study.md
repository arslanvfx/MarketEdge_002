...
**How to apply:** Anchor every variant's opening time, guard warmup, and reported time remaining to the expected 15-minute close. Use cached close time only for identity validation. Schedule bounded best-effort persistence after live work, and keep settlement/reporting in isolated shadow storage.